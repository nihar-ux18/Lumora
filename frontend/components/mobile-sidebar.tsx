  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <SheetContent
        ...
        className="w-[260px] p-0 bg-[#0A0A0B] border-r border-white/10 md:hidden shadow-2xl outline-none"
      >
        <div className="flex h-full flex-col justify-between">
          ...
          <div className="flex flex-col">
            <div className="flex h-16 items-center justify-between px-6 border-b border-white/10">
              ...
              <button
                onClick={onClose}
                className="p-1.5 rounded-lg text-muted-foreground hover:bg-white/5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A00FF]/50"
              ...
              {NAV_ITEMS.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    onClick={onClose}
                    className="relative block rounded-[12px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A00FF]/50"
                  >
                    <div
          ...
          <div className="p-4 border-t border-white/10">
            <Link
              href="/settings"
              onClick={onClose}
              className="block rounded-[12px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A00FF]/60"
            >
              <div
