    ...
    <div className="mt-6">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-[11px] uppercase tracking-wider">
          <span className="bg-[#131316] px-2 text-muted-foreground">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-[12px] bg-white/5 border border-white/10 px-4 py-2.5 text-xs font-medium text-foreground hover:bg-white/10 transition-colors focus:outline-none"
        >
